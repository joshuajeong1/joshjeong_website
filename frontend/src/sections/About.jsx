        ...
        <>
            <div class="flex space-x-10 grow">
                <div class="mt-10 flex w-1/2 flex-col justify-center">
                    ...
                    <p class="mt-8 text-xl text-white">When I'm not working on projects, you can find me at the gym, playing video games, or studying foreign languages.</p>
                ...
                <div class="m-10 grid w-1/2 grid-cols-2 grid-rows-2 gap-3">
                    <div class="col-span-2 bg-gray-700"><Spotify /></div>
