...
function Skills() {
    return (
        <>
            <div className="grid grid-cols-2 grid-rows-[40px, 3fr] items-start gap-y-10 gap-x-10">
                <h1 className="bottom-0 font-bold text-5xl col-span-2">My <span className="text-indigo-500">Toolbox</span></h1>
