...
function Hero() {
    return (
        ...
        <div className="min-h-screen w-screen bg-gray-950">
                <div className="relative pt-[150px] xl:pt-0 xl:grid gap-y-10 flex flex-col xl:grid-cols-2 xl:gap-x-10 min-h-screen items-center w-full">
                    ...
                    <div className="order-1 xl:order-2 flex flex-col items-center justify-center">
                        ...
                        <div className="border-wrapper relative h-48 w-48 sm:h-64 sm:w-64 xl:h-80 xl:w-80 2xl:h-120 2xl:w-120 rounded-full overflow-hidden">
                            <div className="rounded-full w-[98%] h-[98%] absolute overflow-hidden left-[1%] top-[1%]">
