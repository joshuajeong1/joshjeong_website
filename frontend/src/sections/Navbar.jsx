...
function Navbar() {
    ...
    return (
        <motion.div className="fixed top-0 left-0 w-full y-10 z-50 overflow-hidden bg-gray-950"
            variants={{
                visible: { y: 0 },
                hidden: { y: "-100%"}
            }}
        ...
        >
            <div className="flex items-center justify-between space-x-10 p-10">
                <a href="#" className="text-white font-bold text-sm md:text-lg xl:text-xl">joshjeong<span className="text-fuchsia-400">.</span><span className="text-emerald-400">dev</span></a>
                <div>
